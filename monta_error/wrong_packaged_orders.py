...
df_excel['Datum'] = pd.to_datetime(df_excel['date_created'], errors='coerce').dt.strftime('%d-%m-%Y')
...
# Save the Excel files locally
with open('verkeerd_verpakte_orders.xlsx', 'wb') as f:
    f.write(excel_buffer_1.getbuffer())
